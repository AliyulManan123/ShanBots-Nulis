...
reply(`Ada Apa Kak?`)
        ...
        //MAGER NULIS//
        case '/magernulis1a':
            if (args.length === 1) return m.reply(from, 'Kirim Perintah */magernulis1a [text]*', id)
            const diTulis = body.slice(14)
            await m.reply(from, menulis.magernulissatu, id)
            ...
            .on('error', () => m.reply(from, menulis.errormagernulissatu, id))
            .on('exit', () => {
                XeonBotInc.sendImage(from, './MFarelSZ/Zahraaa/magernulis1√.jpg', 'MFarelSZ.jpg', '*Sukses✓ Nulis DiBuku ✓*\n\n*YouTube : MFarelS CH*\n*Instagram : @mfarelsyahtiawan*\n*Twitter : @MSyahtiawan*\n*GitHub : @MFarelS*\n*Saweria : MFarelS*\n\n*© 2021 MFarelS✓*', id)
            })
            break
        case '/magernulis1b':
            if (args.length === 1) return m.reply(from, 'Kirim Perintah */magernulis1b [text]*', id)
            ...
            break
        case '/magernulis1c':
            if (args.length === 1) return m.reply(from, 'Kirim Perintah */magernulis1c [text]*', id)
            ...
            break
        case '/magernulis1d':
            if (args.length === 1) return await m.reply(from, 'Kirim Perintah */magernulis1d [teks]*', id)
            ...
            break
        case '/magernulis1e':
            if (args.length === 1) return await m.reply(from, 'Kirim Perintah */magernulis1e [teks]*', id)
            ...
            break
        case '/magernulis1f':
            if (args.length === 1) return await m.reply(from, 'Kirim Perintah */magernulis1f [teks]*', id)
            ...
            break
        case '/magernulis1g':
                if (args.length === 4) return await m.reply(from, 'Kirim Perintah */magernulis1g --[nama]--[kelas]--[teks]*', id)
                arg = body.trim().split('--')
                const diNama = arg[1]
                const diKelas = arg[2]
                ...
                .on('error', () => m.reply(from, 'Error Bjeer, Keknya Scriptnya Lagi Error', id))
                .on('exit', () => {
                    XeonBotInc.sendImage(from, './MFarelSZ/Zahraaa/magernulis1√.jpg', 'Jarot.jpg', '*Sukses✓ Nulis DiBuku ✓*\n\n*YouTube : MFarelS CH*\n*Instagram : @mfarelsyahtiawan*\n*Twitter : @MSyahtiawan*\n*GitHub : @MFarelS*\n*Saweria : MFarelS*\n\n*© 2021 MFarelS✓*', id)
                })
            break
        case '/magernulis1h':
                if (args.length === 4) return await m.reply(from, 'Kirim Perintah */magernulis1h --[nama]--[kelas]--[teks]*', id)
                arg = body.trim().split('--')
                const diNama2 = arg[1]
            ...
            break
        case '/magernulis1i':
                if (args.length === 4) return await m.reply(from, 'Kirim Perintah */magernulis1i --[nama]--[kelas]--[teks]*', id)
                arg = body.trim().split('--')
                const diNama3 = arg[1]
